          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={chartData}>
              ...
              <Tooltip
                ...
                formatter={(value) => [`${value} GB`, 'Cumulative Saved']}
              />
              <Line
                type="monotone"
                ...
                {recentActivity.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td className="text-green-400">
                      {item.space_saved > 0 ? formatBytes(item.space_saved) : '-'}
                    </td>
                  </tr>
                ))}
              </tbody>
...
function StatCard({ label, value, icon, color = 'text-white', subtitle, small }) {
  return (
