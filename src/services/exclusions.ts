...
import type { ExclusionCheck, PathExclusionResult, ExclusionMatch } from '../types/index.js';

/**
 * Check if a file path is excluded based on exclusion rules
 */
export function isExcluded(filePath: string, libraryId: number): ExclusionCheck {
 ...
 */
export function checkPathExclusion(filePath: string, libraryId: number | null = null): PathExclusionResult {
